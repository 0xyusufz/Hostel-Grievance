...
## Remaining risks (Low)
In-memory rate-limit not distributed, sequential `GRV-0001` enumerable (blocked by 403, consider UUID), no CAPTCHA/WAF, existing `sha256` hashes need reseed, no 2FA.
